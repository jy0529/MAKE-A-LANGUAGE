...
export class FunctionType extends Type {
    ...
    toString(): string {
        ...
        for (let pt of this.paramTypes) {
            paramTypeNames += pt.name + ", ";
        }
        paramTypeNames += "]";
        return `FunctionType(returnType: ${this.returnType.name}, paramTypes: ${paramTypeNames})`;
    }
...
export class SysTypes {
    ...
    // 函数没有任何返回值的情况
    // 如果作为变量的类型，则智能赋值为 null 或 undefined
